        ...
        <div class="row mt-5 g-4">
          <div class="col-md-4">
            <div class="soft-card text-center p-4">
              ...
              <p>
                ...
                Creativas • Cognitivas • Socioemocionales • Estéticas El
          ...
          <div class="col-md-4">
            <div class="soft-card text-center p-4">
              ...
              <p>
                • Creatividad: Fomentamos la exploración de nuevas ideas y
                formas de expresión. • Respeto: Valoramos la diversidad
                cultural, las opiniones y los sentimientos de todos los miembros
                de la comunidad. • Solidaridad: Promovemos el trabajo en equipo
                y la colaboración para alcanzar objetivos comunes. • Excelencia:
                Buscamos la mejora continua en todos los aspectos de nuestra
                práctica educativa. • Identidad: Fortalecemos el sentido de
          ...
          <p class="text-center description">
            ...
            ubicamos en Dir. Meglioli 528 sur, Rivadavia. Somos un espacio que
            promueve el desarrollo integral de los individuos desde la primera
            infancia y sin límite de edad, teniendo a la educación artística
            como eje central. Contamos con un equipo interdisciplinario de
            profesionales y ofrecemos un lugar de excelencia con ambientes
            activos modificantes, rodeado de un entorno natural que inspira la
            motivación y la creatividad. Nuestra oferta educativa incluye: •
            Trayectos con Aval Ministerial: Danza Clásica, Danza Contemporánea,
            Danzas Árabes, Recitación y Arte Escénico. • Talleres Anuales
            Progresivos: Teatro, Música, Artes Visuales, Acrobacia en Telas,
            Canto, Dabke, Idioma Árabe, Ritmos Latinos, entre otros.
          </p>
        </div>
      </div>
    </section>
            ...
            <div class="d-flex justify-content-center">
              <div class="flip-card">
                <div class="flip-inner">
                  <div
                    class="flip-front"
                    style="background-image: url('img/gal1.jpg')"
                  >
            ...
            <div class="d-flex justify-content-center">
              <div class="flip-card">
                <div class="flip-inner">
                  <div
                    class="flip-front"
                    style="background-image: url('img/curso3.jpg')"
                  >
    ...
    <section id="contacto" class="container py-5">
      ...
      <form class="row g-4 mt-4">
        <div class="col-md-6">
          ...
          ><input class="form-control form-soft" />
        </div>
        <div class="col-md-6">
